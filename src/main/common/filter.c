...
{
    const float RC = sampleRate / (M_2PIf * cutoff);
    return 1.0f / (RC + 1.0f);
}
...
{
    // 1.553773974 = 1 / sqrt( (2^(1 / order) - 1)) ; order=2
...
{
    // 1.961459177 = 1 / sqrt( (2^(1 / order) - 1)) ; order=3
...
{
    // 2.298959223 = 1 / sqrt( (2^(1 / order) - 1)) ; order=4
