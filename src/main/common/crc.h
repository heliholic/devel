...
#define crc8_kiss(crc, s)                           crc8_calc(crc, a, 0x07)
#define crc8_kiss_update(crc, data, length)         crc8_update(crc, data, length, 0x07)
...
#define crc16_ccitt_update(crc, data, length)       crc16_update(crc, data, length, 0x1021)
#define crc16_ccitt_sbuf_append(dst, data)          crc16_sbuf_append(dst, data, 0x1021)

#define crc16_modbus(crc, data)                     crc16_calc(crc, data, 0x8005)
#define crc16_modbus_update(crc, data, length)      crc16_update(crc, data, length, 0x8005)
