...
static telemetrySensor_t smartportTelemetrySensors[] =
{
    ...
    TLM_SENSOR(GPS_SATS,                0x5466,   500,  3000,   1,  10,   INT),
    ...
    TLM_SENSOR(CPU_LOAD,                0x52C0,   200,  3000,   1,  10,   INT),
    TLM_SENSOR(SYS_LOAD,                0x52C1,   200,  3000,   1,  10,   INT),
    TLM_SENSOR(RT_LOAD,                 0x52C2,   200,  3000,   1,  10,   INT),
