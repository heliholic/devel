...
static telemetrySensor_t smartportTelemetrySensors[] =
{
    ...
    TLM_SENSOR(PITCH_CONTROL,           0x51A0,   100,  3000,   1,  10,   INT),
    TLM_SENSOR(ROLL_CONTROL,            0x51A1,   100,  3000,   1,  10,   INT),
    TLM_SENSOR(YAW_CONTROL,             0x51A2,   100,  3000,   1,  10,   INT),
    TLM_SENSOR(COLLECTIVE_CONTROL,      0x51A3,   100,  3000,   1,  10,   INT),
    TLM_SENSOR(THROTTLE_CONTROL,        0x51A4,   100,  3000,   1,  10,   INT),
    ...
    TLM_SENSOR(ESC1_POWER,              0x5268,   100,  3000,   1,  10,   INT),
    TLM_SENSOR(ESC1_THROTTLE,           0x5269,   100,  3000,   1,  10,   INT),
    ...
    TLM_SENSOR(HEADING,                 0x5210,   100,  3000,   1,  10,   INT),
    ...
    TLM_SENSOR(CPU_LOAD,                0x51D0,   200,  3000,   1,  10,   INT),
    TLM_SENSOR(SYS_LOAD,                0x51D1,   200,  3000,   1,  10,   INT),
    TLM_SENSOR(RT_LOAD,                 0x51D2,   200,  3000,   1,  10,   INT),

    TLM_SENSOR(MODEL_ID,                0x5120,   200,  3000,   0,   0,   INT),
    TLM_SENSOR(FLIGHT_MODE,             0x5121,   100,  3000,   1,   1,   INT),
    TLM_SENSOR(ARMING_FLAGS,            0x5122,   100,  3000,   1,   1,   INT),
    TLM_SENSOR(ARMING_DISABLE_FLAGS,    0x5123,   100,  3000,   1,   1,   INT),
    TLM_SENSOR(RESCUE_STATE,            0x5124,   100,  3000,   1,   1,   INT),
    TLM_SENSOR(GOVERNOR_STATE,          0x5125,   100,  3000,   1,   1,   INT),

    TLM_SENSOR(PID_PROFILE,             0x5130,   200,  3000,   1,   1,   INT),
    TLM_SENSOR(RATES_PROFILE,           0x5131,   200,  3000,   1,   1,   INT),
...
static const telemetrySensorConfig_t smartPortTelemetrySensorConfig =
{
    .batVoltageScale    = 10,
    .batCurrentScale    = 100,
    .escVoltageScale    = 10,
...
{
    telemetrySetConfig(&smartPortTelemetrySensorConfig);
