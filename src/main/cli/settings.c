...
// PG_PID_PROFILE
    ...
    { "rescue_alt_p_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_p_gain) },
    { "rescue_alt_i_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_i_gain) },
    { "rescue_alt_c_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_c_gain) },
    ...
    { "rescue_max_collective_rate", VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 10, 2500 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.max_collective_rate) },
    { "rescue_max_climb_speed",     VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.max_climb_speed) },
