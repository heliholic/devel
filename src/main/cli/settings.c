...
static const char * const lookupTableEscSensorProtocol[] = {
    "OFF", "KISS", "HOBBYWINGV4", "HOBBYWINGV5", "KONTRONIK", "OMPHOBBY", "ZTW", "SCORPION_UNC", // "COLLECT",
};
#endif
...
// PG_RX_CONFIG
    { "rx_pwm_pulse_min",           VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { PWM_PULSE_MIN, PWM_PULSE_MAX }, PG_RX_CONFIG, offsetof(rxConfig_t, rx_pwm_pulse_min) },
    { "rx_pwm_pulse_max",           VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { PWM_PULSE_MIN, PWM_PULSE_MAX }, PG_RX_CONFIG, offsetof(rxConfig_t, rx_pwm_pulse_max) },
...
// PG_RC_CONTROLS_CONFIG
    ...
    { "rc_scale",                   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 250, 750 }, PG_RC_CONTROLS_CONFIG, offsetof(rcControlsConfig_t, rc_scale) },
