...
// PG_PID_PROFILE
    ...
    { "rescue_alt_ap_gain",         VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_ap_gain) },
    { "rescue_alt_ad_gain",         VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_ad_gain) },
    { "rescue_alt_vp_gain",         VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_vp_gain) },
    { "rescue_alt_vi_gain",         VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.alt_vi_gain) },
