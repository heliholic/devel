...
// PG_PID_PROFILE
    ...
    { "roll_pitch_crosstalk_mode",   VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_SETPOINT }, PG_PID_PROFILE, offsetof(pidProfile_t, roll_pitch_crosstalk_mode) },
    { "roll_pitch_crosstalk_gain",   VAR_INT16 | PROFILE_VALUE, .config.minmax = { -10000, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, roll_pitch_crosstalk_gain) },
    { "roll_pitch_crosstalk_cutoff", VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, roll_pitch_crosstalk_cutoff) },
