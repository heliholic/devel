...
// PG_GOVERNOR_CONFIG
    ...
    { "gov_base_charge",            VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 5, 250 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_base_charge) },
...
// PG_PID_PROFILE
    ...
    { "gov_use_dyn_base_throttle",  VAR_UINT32 | PROFILE_VALUE | MODE_BITSET, .config.bitpos = GOV_FLAG_DYN_BASE_THROTTLE, PG_PID_PROFILE, offsetof(pidProfile_t, governor.flags) },
