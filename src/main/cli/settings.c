...
// PG_DISPLAY_PORT_MSP_CONFIG
    ...
    { "esc_sensor_hw4_current_scale",   VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 254 }, PG_ESC_SENSOR_CONFIG, offsetof(escSensorConfig_t, hw4_current_scale) },
    { "esc_sensor_hw4_voltage_div",     VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 254 }, PG_ESC_SENSOR_CONFIG, offsetof(escSensorConfig_t, hw4_voltage_div) },
#endif
