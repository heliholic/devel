...
// PG_PID_PROFILE
    ...
    { "rescue_var_p_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.var_p_gain) },
    { "rescue_var_i_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.var_p_gain) },
    { "rescue_var_d_gain",          VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.var_p_gain) },
