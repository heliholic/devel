...
const char * const lookupTablePrecompSource[] = {
    "DEFLECTION", "SETPOINT",
};
...
const lookupTableEntry_t lookupTables[] = {
    ...
    LOOKUP_TABLE_ENTRY(lookupTablePrecompSource),
};
...
// PG_MIXER_CONFIG
    ...
    { "tail_motor_exponent",        VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 10, 250 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, tail_motor_exponent) },
    { "tail_pitch_exponent",        VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 10, 250 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, tail_pitch_exponent) },
...
// PG_PID_PROFILE
    ...
    { "yaw_precomp_source",         VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_PRECOMP_SOURCE }, PG_PID_PROFILE, offsetof(pidProfile_t, yaw_precomp_source) },
    { "yaw_precomp_exponentonent",       VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 25, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, yaw_precomp_exponent) },
