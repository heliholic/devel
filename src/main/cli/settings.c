...
// PG_PID_PROFILE
    ...
    { "error_decay_time_curve_cyclic",   VAR_UINT8 | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 11, PG_PID_PROFILE, offsetof(pidProfile_t, error_decay_time_curve_cyclic) },
    { "error_decay_limit_curve_cyclic",  VAR_UINT8 | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 11, PG_PID_PROFILE, offsetof(pidProfile_t, error_decay_limit_curve_cyclic) },
    { "error_decay_time_curve_offset",   VAR_UINT8 | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 11, PG_PID_PROFILE, offsetof(pidProfile_t, error_decay_time_curve_offset) },
    { "error_decay_limit_curve_offset",  VAR_UINT8 | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 11, PG_PID_PROFILE, offsetof(pidProfile_t, error_decay_limit_curve_offset) },
