...
// PG_PID_PROFILE
    ...
    { "pid_yaw_dterm_mode",         VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 2 }, PG_PID_PROFILE, offsetof(pidProfile_t, yaw_dterm_mode) },
    ...
    { "attitude_relax_cutoff",      VAR_UINT8  | PROFILE_VALUE | MODE_ARRAY, .config.array.length = 3, PG_PID_PROFILE, offsetof(pidProfile_t, attitude.relax_cutoff) },
