...
// PG_RX_CONFIG
    ...
    { PARAM_NAME_RC_SMOOTHING_SETPOINT_DELTA_CUTOFF, VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, UINT8_MAX }, PG_RX_CONFIG, offsetof(rxConfig_t, rc_smoothing_setpoint_delta_cutoff) },
