...
// PG_PID_PROFILE
    ...
    { "rescue_max_collective_rate", VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 5000 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.max_collective_rate) },
    { "rescue_max_climb_rate",      VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, rescue.max_climb_rate) },
