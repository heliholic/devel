...
// PG_GOVERNOR_CONFIG
    ...
    { "gov_throttle_cut_timeout",   VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 100 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_throttle_cut_timeout) },
    { "gov_handover_throttle",      VAR_UINT8  |  MASTER_VALUE,  .config.minmaxUnsigned = { 5, 75 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_handover_throttle) },
...
// PG_PID_PROFILE
    ...
    { "gov_use_direct_throttle",    VAR_UINT32 | PROFILE_VALUE | MODE_BITSET, .config.bitpos = GOV_FLAG_DIRECT_THROTTLE, PG_PID_PROFILE, offsetof(pidProfile_t, governor.flags) },
    ...
    { "gov_yaw_weight",             VAR_UINT8  |  PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, governor.yaw_weight) },
    { "gov_cyclic_weight",          VAR_UINT8  |  PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, governor.cyclic_weight) },
    { "gov_collective_weight",      VAR_UINT8  |  PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, governor.collective_weight) },
    ...
    { "gov_collective_curve",       VAR_UINT8  |  PROFILE_VALUE,  .config.minmaxUnsigned = { 0, GOV_CURVE_LAST }, PG_PID_PROFILE, offsetof(pidProfile_t, governor.collective_curve) },
