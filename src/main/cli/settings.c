...
// PG_MIXER_CONFIG
    ...
    { "swash_crosstalk_gain",       VAR_INT16  | MASTER_VALUE,  .config.minmax = { -1000, 1000 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, swash_crosstalk_gain) },
    { "swash_crosstalk_cutoff",     VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 1, 100 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, swash_crosstalk_cutoff) },
