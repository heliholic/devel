...
void resetPidProfile(pidProfile_t *pidProfile)
{
    RESET_CONFIG(pidProfile_t, pidProfile,
        ...
        .rescue.hover_altitude = 1000,
        .rescue.vario_p_gain = 250,
        .rescue.vario_i_gain = 100,
        .rescue.vario_d_gain = 0,
        .rescue.alt_gain = 250,
        .rescue.alt_cutoff = 20,
        .rescue.var_cutoff = 10,
        .rescue.acc_cutoff = 5,
        .rescue.max_climb_rate = 100,
