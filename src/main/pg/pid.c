...
void resetPidProfile(pidProfile_t *pidProfile)
{
    RESET_CONFIG(pidProfile_t, pidProfile,
        ...
        .error_decay_rate_curve = { 16,17,19,22,25,29,36,45,62,100,250,250,250,250,250,250 },
        .error_decay_limit_curve = { 11,11,11,11,11,11,11,11,11,11,11,12,13,14,15,16 },
        ...
        .offset_charge_curve = { 100,100,100,100,100,95,83,71,63,56,50,45,41,38,36,33 },
        .error_rotation = true,
        ...
        .cyclic_cross_coupling_cutoff = 20,
        .antigravity_gain = 0,
