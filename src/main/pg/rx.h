...
typedef struct rxConfig_s {
    ...
    uint8_t rc_smoothing_cutoff;               // Filter cutoff frequency for the smoothing filter (0 = auto)
    uint8_t rc_smoothing_factor;               // Used to adjust the "smoothness" determined by the auto cutoff calculations
