...
typedef struct pidProfile_s {
    ...
    uint8_t             error_decay_time_curve_cyclic[11];
    uint8_t             error_decay_limit_curve_cyclic[11];
    uint8_t             error_decay_time_curve_offset[11];
    uint8_t             error_decay_limit_curve_offset[11];
