...
typedef struct pidProfile_s {
    ...
    uint8_t             error_decay_time_curve_cyclic[LOOKUP_CURVE_POINTS];
    uint8_t             error_decay_limit_curve_cyclic[LOOKUP_CURVE_POINTS];
    uint8_t             error_decay_time_curve_offset[LOOKUP_CURVE_POINTS];
    uint8_t             error_decay_limit_curve_offset[LOOKUP_CURVE_POINTS];
    uint8_t             error_bleed_time_curve_offset[LOOKUP_CURVE_POINTS];
    uint8_t             error_bleed_limit_curve_offset[LOOKUP_CURVE_POINTS];
