...
bool w25n_detect(flashDevice_t *fdevice, uint32_t jedecID)
{
    ...
    const uint32_t managementStartBlock = fdevice->geometry.sectors - W25N_BB_MANAGEMENT_BLOCKS;
