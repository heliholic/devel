...
static void mixerUpdateSwash(void)
{
    ...
    {
        const float SR = inputValue(ROLL) + mixer.swashTrim[0];
        const float SP = inputValue(PITCH) + mixer.swashTrim[1];
        const float SC = inputValue(COLLECTIVE) + mixer.swashTrim[2];
