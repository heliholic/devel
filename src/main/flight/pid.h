...
#define PID_ROLL_DEFAULT            { .P = 50, .I = 100, .D = 0, .F = 100, .error_limit = 90 }
#define PID_PITCH_DEFAULT           { .P = 50, .I = 100, .D = 0, .F = 100, .error_limit = 90 }
#define PID_YAW_DEFAULT             { .P = 50, .I =  50, .D = 0, .F =   0, .error_limit = 90 }
