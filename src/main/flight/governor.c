...
void governorInit(const pidProfile_t *pidProfile)
{
    ...
    if (getMotorCount() > 0)
    {
        ...
        difFilterInit(&gov.differentiator, governorConfig()->gov_rpm_filter, gyro.targetRateHz);
        ...
        lowpassFilterInit(&gov.TTAFilter, LPF_PT1, governorConfig()->gov_tta_filter, gyro.targetRateHz, 0);
