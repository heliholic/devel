...
static bool mspProcessOutCommand(int16_t cmdMSP, sbuf_t *dst)
{
    ...
    case MSP_PID_ADVANCED:
        ...
        sbufWriteU16(dst, 0); // currentPidProfile->yaw_center_offset
        ...
        sbufWriteU8(dst, 0); // currentPidProfile->cyclic_normalization
        sbufWriteU8(dst, 0); // currentPidProfile->collective_normalization
        sbufWriteU16(dst, 0); // currentPidProfile->rescue_collective
        sbufWriteU16(dst, 0); // currentPidProfile->rescue_boost
        sbufWriteU8(dst, 0); //currentPidProfile->rescue_delay
...
static mspResult_e mspProcessInCommand(mspDescriptor_t srcDesc, int16_t cmdMSP, sbuf_t *src)
{
    ...
    case MSP_SET_PID_ADVANCED:
        ...
        sbufReadU8(src); // iterm_relax ON/OFF
        ...
        sbufReadU16(src); // currentPidProfile->yaw_center_offset
        ...
        sbufReadU8(src); // currentPidProfile->cyclic_normalization
        sbufReadU8(src); // currentPidProfile->collective_normalization
        sbufReadU16(src); // currentPidProfile->rescue_collective
        sbufReadU16(src); // currentPidProfile->rescue_boost
        sbufReadU8(src); // currentPidProfile->rescue_delay
    ...
    case MSP_SET_RX_CONFIG:
        ...
        rxConfigMutable()->rc_smoothing_mode = sbufReadU8(src);
#endif
#ifdef USE_RX_SPI
